...
const BrandsPages = () => {
  const { brandDelete, changeActionStatusBrand } = useContext(AuthContext);
  ...
  const changeActiveStatus = (id, is_active) => {
    ...
    changeActionStatusBrand(id, is_active)
      .then((response) => {
  ...
  // search filter
  const filteredCategories = brandsData.data.results.filter((data) =>
    ...
    <div className=" container-fluid px-lg-3 ">
      ...
      <div className="mb-2  d-lg-flex justify-content-between align-items-center">
        <div className="">
          ...
          <span className="path-text-span">Brands</span>
