...
const VariantOptionList = () => {
  const { deleteVariantOption, changeActionStatusVariantOption } =
  ...
  const changeActiveStatus = (id, is_active) => {
    ...
    changeActionStatusVariantOption(id, is_active)
      .then((response) => {
    ...
    <div className=" container-fluid px-lg-3 ">
      ...
      <div className="mb-2  d-lg-flex justify-content-between align-items-center">
        <div className="">
          ...
          <span className="path-text-span">Variant-Option</span>
          <div className="page-title">Variant Option List</div>
        </div>
      </div>
      {/* Table div */}
