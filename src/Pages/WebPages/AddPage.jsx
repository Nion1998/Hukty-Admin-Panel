...
const AddPage = () => {
  const { addPage, uploadImage } = useContext(AuthContext);
  ...
  const handleFormSubmit = async (event) => {
    ...
    addPage(title, video_url, desc, page_type, is_active, thumbnail, attachment)
      .then(() => {
    ...
    <div className="container-fluid">
      <div className="py-3 d-flex justify-content-between align-items-center">
        <div>
          ...
          <span className="path-text-span">Add Page</span>
            ...
            <div className="row gy-4 gx-5">
              ...
              <div className="col-12 col-md-6 ">
                <div className={`form-group ${error.id ? "error" : ""}`}>
                  ...
                  <Form.Select as="select" name="page_type">
